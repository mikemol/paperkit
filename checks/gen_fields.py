...
_FIELD_DOC = {
    ...
    "local":    ("the check's enforcement tier — local=true runs it on the host (a toolchain-coupled "
                 "check), gated but not mutation-swept; default is the hermetic sandbox (Ζ·tier)", "warrant"),
