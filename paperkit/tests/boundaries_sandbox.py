...
def main() -> int:
    ...
    saved = os.environ.get("PAPERKIT_ROOT"); os.environ.pop("PAPERKIT_ROOT", None)
    hp = Path(tempfile.mkdtemp(dir=Path.home()))   # a project whose inferred parent IS $HOME
    try:
        ...
        declared_ok = layout._sandbox_root(hp) == hp
        ok = refused and declared_ok
