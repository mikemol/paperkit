...
Walking the claim DAG from premises to conclusions, each claim's adequacy grade plots against its dependency depth [@rpt-dag] — premises (depended upon) on the left, terminal conclusions on the right, the effective grade on the vertical axis [@rpt-dag-fig].

![premises (depended upon) on the left, terminal conclusions on the right, the effective grade on the vertical axis](assets/dag.svg)
